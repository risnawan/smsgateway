...
public class progress extends javax.swing.JFrame {
    ...
    public static String str = "Loading... " + nilai;

    public progress() {
        initComponents();
        jProgressBar1.setValue(nilai);
        jProgressBar1.setString(str);
    }
    //The thread

    public static void update(int nilai) {
        jProgressBar1.setValue(nilai);
        jProgressBar1.setString(str);
    ...
    private void initComponents() {
        ...
        jProgressBar1.setFont(new java.awt.Font("Comic Sans MS", 0, 14)); // NOI18N
        jProgressBar1.setValue(80);
        jProgressBar1.setString("Loading 0%");
        jProgressBar1.setStringPainted(true);

        jButton1.setText("Hentikan");
